...
public class MFXGenericDialogBuilder {
	...
	/**
	 * Uses the {@link #MFXGenericDialogBuilder(MFXGenericDialog)} constructor,
	 * starts from the given dialog.
	 */
	...
	/**
	 * Makes the dialog's content scrollable using
	 * {@link MFXGenericDialog#buildScrollableContent(boolean)}.
	 */
