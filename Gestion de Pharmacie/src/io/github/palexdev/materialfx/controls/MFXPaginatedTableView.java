 ...
 * <p>
 * - The number of pages to show in the pagination control,
 * {@link #pagesToShowProperty()}
 * <p>
 * - The number of rows per page
 * <p>
 * </p>
 * This table view extends {@link MFXTableView} because it uses the same system
 * (uses a virtual flow),
 * the page navigation is just a trick. The scroll bars are hidden and the
 * scroll value is handled/updated
...
public class MFXPaginatedTableView<T> extends MFXTableView<T> {
    ...
    private final IntegerProperty pagesToShow = new SimpleIntegerProperty(20);
    private final IntegerProperty rowsPerPage = new SimpleIntegerProperty(15);
